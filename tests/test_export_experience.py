...
class TestExportAPI:
    def test_returns_200(self, client, cartridge_id):
        resp = client.get(f"/api/cartridges/{cartridge_id}/export")
        assert resp.status_code == 200

    def test_returns_cartridge(self, client, cartridge_id):
        data = client.get(f"/api/cartridges/{cartridge_id}/export").json()
    ...
    def test_filename_is_deterministic(self, client, cartridge_id):
        r1 = client.get(f"/api/cartridges/{cartridge_id}/export").json()
        r2 = client.get(f"/api/cartridges/{cartridge_id}/export").json()
    ...
    def test_404_for_unknown(self, client):
        resp = client.get("/api/cartridges/00000000-0000-0000-0000-000000000000/export")
...
class TestCanonicalSerialization:
    def test_exported_json_matches_serializer(self, client, cartridge_id):
        export = client.get(f"/api/cartridges/{cartridge_id}/export").json()
        cartridge = client.get(f"/api/cartridges/{cartridge_id}").json()["cartridge"]
    ...
    def test_export_is_immutable(self, client, cartridge_id):
        export1 = client.get(f"/api/cartridges/{cartridge_id}/export").json()
        client.get(f"/api/cartridges/{cartridge_id}/export")
        export2 = client.get(f"/api/cartridges/{cartridge_id}/export").json()
